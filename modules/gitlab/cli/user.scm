;;; group.scm -- Implementation of 'gitlab-cli user' command.
...
;; This module contains implementation of 'gitlab-cli user' command that can
;; be used to work with GitLab Users API.
